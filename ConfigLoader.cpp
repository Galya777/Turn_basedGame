...
Armor* CommanderLoader::createArmor(const std::string& name) {
    if (name == "Unarmored") {
        Unarmored armor;
        return armor.clone();
...
Unit* CommanderLoader::createUnit(const std::string& unitType, bool isCommander) {
    if (isCommander) {
...
void CommanderLoader::assignUnitsToCommander(Comander* commander, const std::vector<std::string>& unitTypes) {
...
bool CommanderLoader::commanderNameExists(const std::string& name) {
...
void CommanderLoader::parseCommanderLine(const std::string& line, bool isLiving) {
...
void CommanderLoader::loadCommandersFromFile(const std::string& filename, bool isLiving) {
...
const std::vector<Comander*>& CommanderLoader::getLivingCommanders() const {
    return livingCommanders;
}

const std::vector<Comander*>& CommanderLoader::getUndeadCommanders() const {
    return undeadCommanders;
}
